...
{% openapi src="../.gitbook/assets/openapi-nanobanana.yaml" path="/v1/task/create-image-edit" method="post" %}
[openapi-nanobanana.yaml](../.gitbook/assets/openapi-nanobanana.yaml)
{% endopenapi %}
